...
To analyze the dataset introduced in Section \ref{sec:data}, 
a complex heterograph with 55K nodes and 264K edges featuring five distinct types of nodes and edges, 
